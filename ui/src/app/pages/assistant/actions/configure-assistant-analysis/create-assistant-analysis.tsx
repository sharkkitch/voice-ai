    ...
    try {
      ...
      CreateAnalysis(
        ...
        (err, response) => {
          if (err) {
            setErrorMessage(
              'Unable to create assistant analysis, please check and try again.',
            );
          }
  ...
  return (
    ...
    >
      ...
      <div className="overflow-auto flex flex-col flex-1 pb-20">
        <PageHeaderBlock>
          <PageTitleBlock>New Analysis</PageTitleBlock>
        </PageHeaderBlock>
        ...
        <div className="px-8 pt-6 pb-8 max-w-4xl flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-6">
            ...
            <FieldSet className="w-40">
              ...
              />
              <InputHelper>
                Lower numbers execute first when multiple analyses are triggered.
              </InputHelper>
            </FieldSet>
          </div>
        </div>
      ...
      <PageActionButtonBlock errorMessage={errorMessage}>
        ...
        <IBlueBGArrowButton type="submit" className="w-full h-full">
          Configure analysis
        </IBlueBGArrowButton>
