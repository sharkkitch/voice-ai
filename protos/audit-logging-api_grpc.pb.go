...
func (c *auditLoggingServiceClient) GetAllAuditLog(ctx context.Context, in *GetAllAuditLogRequest, opts ...grpc.CallOption) (*GetAllAuditLogResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuditLoggingService_GetAllAuditLog_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *auditLoggingServiceClient) GetAuditLog(ctx context.Context, in *GetAuditLogRequest, opts ...grpc.CallOption) (*GetAuditLogResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuditLoggingService_GetAuditLog_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *auditLoggingServiceClient) CreateMetadata(ctx context.Context, in *CreateMetadataRequest, opts ...grpc.CallOption) (*CreateMetadataResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuditLoggingService_CreateMetadata_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedAuditLoggingServiceServer should be embedded to have forward compatible implementations.
